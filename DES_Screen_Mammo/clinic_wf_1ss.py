...
def get_exam_1ss(env, patient, clinic, rg,  pct_screen_mammo_scheduled,
                              ...
                              pct_dx_mammo_scheduled, pct_dx_us_scheduled,
    ...
    got_us_machine_bx_ts, got_scanner_after_us_bx_ts, got_scanner_bx_ts = pd.NA, pd.NA, pd.NA
    got_dx_scanner_before_us_after_ai_ts, got_dx_scanner_before_us_ts = pd.NA, pd.NA
    ...
    release_us_machine_after_bx_ts, release_scanner_after_post_bx_mammo_ts = pd.NA, pd.NA
    release_dx_scanner_before_us_after_ai_ts, release_dx_scanner_before_us_ts = pd.NA, pd.NA
...
def run_clinic_1ss(env, clinic, mean_interarrival_time, rg,
    ...
    while env.now < stoptime and patient < max_arrivals:
        ...
        env.process(get_exam_1ss(env, patient, clinic, rg,
                              pct_screen_mammo_scheduled,
                              pct_screen_mammo_after_ai_dx_mammo_us_scheduled,
                              pct_screen_mammo_after_ai_dx_mammo_scheduled,
                              pct_screen_mammo_after_ai_us_scheduled,
